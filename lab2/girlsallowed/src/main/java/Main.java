...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        QuotationService gaqService = new GAQService(); try {
        ...
        // Register the object with the RMI Registry registry.bind(Constants.GIRLS_ALLOWED_SERVICE, quotationService);
