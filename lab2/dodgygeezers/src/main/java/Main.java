...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        QuotationService dgqService = new DGQService(); try {
        ...
        // Register the object with the RMI Registry registry.bind(Constants.DODGY_GEEZERS_SERVICE, quotationService);;
        ...
        brokerService.registerService(Constants.DODGY_GEEZERS_SERVICE, quotationService);

        System.out.println("STOPPING SERVER SHUTDOWN");
        while (true) {Thread.sleep(1000); } } catch (Exception e) {
